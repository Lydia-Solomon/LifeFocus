<%-- 
    ...
    Created on : May 21, 2023, 8:14:44 PM
    Author     : LYDIA
--%>
                ...
                try{
                    ...
                    if (password != null && confirmPassword != null) {
                        if (!password.equals(confirmPassword)) {
                            ...
                            int i =st.executeUpdate("Insert into donor_registry(`username`,`password`,`name`,`email`,`mobile`,`address`)values('"+username+"','"+confirmPassword+"','"+name+"','"+email+"','"+mobile+"','"+address+"')");
                            ...
                            <form class="donate-form" id="myForm" method="POST">
                                <div class="row ">
                                    <div class="col-lg-12 d-flex flex-column align-content-center">
                                        <h4>DONOR REGISTRATION DETAILS</h4>
                                    </div>
